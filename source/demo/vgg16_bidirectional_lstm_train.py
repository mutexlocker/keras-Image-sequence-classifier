...
def main():
    ...
    data_set_name = 'AM'
    input_dir_path = patch_path('AM_data')
    ...
    history = classifier.fit(data_dir_path=input_dir_path, model_dir_path=output_dir_path, data_set_name=data_set_name,from_picture=True)
